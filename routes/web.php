...
Route::get('/admin/appointmentlist',[AdminController::class,'ajaxAppointments']);
// Route::get('/admin/doctorlist',[AdminController::class,'doctors']);
Route::get('/admin/doctorlist',[AdminController::class,'ajaxListDoctor']);
// Route::get('/admin/patientlist',[AdminController::class,'patients']);
Route::get('/admin/patientlist',[AdminController::class,'ajaxListPatient']);
// Route::get('/admin/reviews',[AdminController::class,'reviews']);
Route::get('/admin/reviews',[AdminController::class,'ajaxReviews']);
// Route::get('/admin/transections',[AdminController::class,'transections']);
Route::get('/admin/transections',[AdminController::class,'ajaxTransections']);
...
Route::get('/admin/patientstatus/{id}',[AdminController::class,'patientstatus']);
