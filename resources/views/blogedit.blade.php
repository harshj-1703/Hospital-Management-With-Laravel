            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-1 col-md-10 col-md-offset-1">
                    ...
                    <form action="{{url('/')}}/updateblog/{{$blog->id}}" method="POST">
                        ...
                        <input type="text" name="title" class="form-control" maxlength="50" value="{{$blog->title}}" 
                        ...
                        <textarea name="detail" class="form-control" maxlength="2000">{{$blog->detail}}</textarea>
                        <br>
                        <button type="submit" class="btn btn-success">Edit</button>
                    </form>
                    @elseif(session()->has('drid'))
                    <form action="{{url('/')}}/updateblogdr/{{$blog->id}}" method="POST">
                        @csrf
                        <div><span class="text-danger">
                            @error('title')
                            {{$message}}
