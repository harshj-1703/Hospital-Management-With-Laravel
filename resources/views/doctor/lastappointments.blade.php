						...
						{{-- <div class="col-md-7 col-lg-8 col-xl-9"> --}}
							<div style="width: 1100px;padding:30px;">
								...
								{{-- <div class="appointment-list"> --}}
									...
									<div class="appointment-action">
                                        @if($app->status == "2")
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-sm bg-warning-light">
                                                <i class="fas fa-check"></i> Panding
                                            </a>
                                        @elseif($app->status == "1")
                                    ...
                                    <td style="text-align: center">
                                        @if($app->status == "2" || $app->status == "0")
                                        <a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
                                            <i class="far fa-thumbs-down"></i> Not Done
                                        </a>
                                        @else
                                        @if($app->appointmentstatus == "1")
                                        <a href="{{url('/')}}/doctor/appointment/missed/{{$app->id}}" class="btn btn-sm bg-success-light">
                                            <i class="far fa-thumbs-up"></i> Done
                                        </a>
                                        @else
                                        <a href="{{url('/')}}/doctor/appointment/notmissed/{{$app->id}}" class="btn btn-sm bg-warning-light">
                                            <i class="far fa-thumbs-down"></i> Missed
                                        </a>
                                        @endif
                                        @endif
                                    </td>
					...
					<div class="modal-body">
						<ul class="info-details">
							...
							<li>
								...
								<span class="text">{{date("d M,Y",strtotime($popapp->bookingdate))}}, 
                                    {{date("h:i a",strtotime($popapp->bookingtime))}}</span>
							</li>
							<li>
